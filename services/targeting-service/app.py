...
if __name__ == '__main__':
    ...
    auth_url = os.getenv('AUTH_SERVICE_URL', 'http://auth.auth.svc.cluster.local:8001')
    log.info(f"Servidor de Targeting iniciado na porta {port} | auth-service={auth_url}")
